...
interface Props {
  ...
  /** Prefilled fields for a new cargo — the mail-derived case, later. Ignored when editing. */
 ...
 */
export default function CargoForm({ open, editing, defaults, onClose, onDeleted }: Props) {
  ...
  useEffect(() => {
    ...
    if (editing) {
      ...
      form.setFieldsValue({ status: 'OPEN', quantityUnit: 'MT', ...defaults });
    }
